...
#import "HCHeader.h"
#define LeftButtonStr @"返回"
#define RightButtonStr @"相册"
...
//        self.navigationItem.rightBarButtonItem = rightBtn;
        ...
        leftButton.frame = CGRectMake(20, 20, 44, 22);
        [self.view addSubview:leftButton];
        [leftButton addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
        
        UIButton *rightButton = [UIButton buttonWithType:UIButtonTypeSystem];
        [rightButton setTitle:RightButtonStr forState:UIControlStateNormal];
        [rightButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        rightButton.frame = CGRectMake(self.view.frame.size.width - 44 - 20, 20, 44, 22);
        [self.view addSubview:rightButton];
        [rightButton addTarget:self action:@selector(openPhoto) forControlEvents:UIControlEventTouchUpInside];
